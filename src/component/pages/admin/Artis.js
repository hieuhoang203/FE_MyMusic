...
import {Button, ConfigProvider, DatePicker, Form, Input, message, Modal, notification, Pagination, Radio, Upload, Spin} from "antd";
    ...
    function updateStatus(id, status) {
        ...
        updateStatusUser(id, status).then((response) => {
            ...
            if (response.data.result.responseCode === '200') {
                ...
                message.open({
                    type: "success",
                    content: status === 'ShutDown' ? "Delete artis successfully!" : "Return artis successfully!",
                    style: {
                        animation: "fadeInOut 2s ease-in-out forwards",
                    },
                })
